...
wget https://var-s-350014.appspot.com/cacheavoid/HelloWorld.java -P /space
# should add a line here that compiles the file; may need to check
# file ownership permissions also
wget https://var-s-350014.appspot.com/cacheavoid/hello.py -P /var/www/cgi-bin
chmod +x /var/www/cgi-bin/hello.py
cp /home/ec2-user/HelloWorld.java /space
wget https://var-s-350014.appspot.com/cacheavoid/index.html -P /var/www/html
